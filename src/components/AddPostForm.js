                ...
                <Col sm="10">
                    <Form onSubmit={onSubmit}>
                        ...
                        <FormGroup>
                            ...
                            <Input type="text" name="body" id="body-field" required/>
                        </FormGroup>
                        <FormGroup>
                            <Label for="author-field">Author</Label>
                            <Input type="text" name="author" id="author-field" required/>
                        </FormGroup>
                        <FormGroup>
                            <Label for="image-field">Image URL</Label>
                            <Input type="text" name="image" id="image-field" required/>
                        </FormGroup>
